...
@section('content')
    ...
    <!--end breadcrumb-->
    <h6 class="mb-0 text-uppercase">Senarai Peranan Pengguna Dipadam</h6>
    <hr />
    <div class="card">
        <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        @isset($user)
                            <form class="d-inline" method="POST" action="{{ route('user-role.forceDelete', $user->id) }}">
                                {{ method_field('delete') }}
                                {{ csrf_field() }}
