...
class DataPTJController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'jenis_data_ptj' => 'required|exists:data_ptjs,jenis_data_ptj',
        ...
        $dataptj = DataPTJ::create([
            ...
            'jenis_data_ptj' => $request->jenis_data_ptj,
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'subunit_id' => 'nullable|exists:sub_units,id',
            'jenis_data_ptj' => 'required|exists:jenis_data_ptjs,jenis_data_ptj',
            'jenis_nilai' => 'required|in:Bilangan,Peratus,Mata Wang',
            'doc_link' => 'nullable|url',
            'jumlah' => 'array',
            'jumlah.*' => 'nullable|numeric',
