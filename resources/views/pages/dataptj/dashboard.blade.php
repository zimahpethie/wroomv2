...
@section('content')
    ...
    <div class="container-fluid mb-4">
        <form id="dashboardFilter" action="{{ route('datautama.dashboard') }}" method="GET">
                    ...
                    <div class="card shadow-sm h-100 border-0 rounded-3">
                        <div class="card-body d-flex flex-column p-3">
                            ...
                            <div class="mt-auto text-end">
                                <a href="{{ route('datautama.show', $item->id) }}" class="btn btn-sm btn-primary rounded-pill">
